    ...
    module C
        module Doxygen
            ...
            def write(description)
                output = Damage::Files.createAndOpen("gen/#{description.config.libname}/doc/", @OUTFILE)
                genDoxyfile(output, description)
                output.close()
            end
            module_function :write

            private
            def genDoxyfile(output, description)
...
PROJECT_NAME           = \"Damage Libray: #{libName}\"

# The PROJECT_NUMBER tag can be used to enter a project or revision number. This
# could be handy for archiving the generated documentation or if some version
# control system is used.

PROJECT_NUMBER         = \"#{description.config.version}\"
