...
/** \\mainpage #{libName}
 *");
                if description.config.description != nil then
                    output.puts("
 * \\section Description")
                ...
                output.puts("
 * \\section Damage
 * #{libName} library was autogenerated by DAMAGE (DAtabase MetA GEnerator)
 * See: https://github.com/nmorey/damage for more infos
 */
")
                output.puts("
